		...
		<!---start-wrap---->
			...
			<div class="header">
					<div class="top-header">
						...
						{
							echo "<h3>Doctor Logged in : ".$_SESSION["dName"]."</h3>" ;
							} 
							?></p>
						</div>
						<div class="clear"> </div>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-2 col-lg-offset-2 toppad" >
                      <div class="panel panel-info">
                        <div class="panel-heading">
                          <h3 class="panel-title"><?php echo $row["first_name"]." ".$row["last_name"]; ?>
                            ...
                            <div class=" col-md-9 col-lg-9 "> 
                              <table class="table table-user-information">
                                <tbody>
								  ...
								  <tr>
                                    <td>Photo</td>
                <td><img src="photo/<?php echo $row["photo"]; ?>" height="200" width="200"  ><br><br></td>
                                  </tr>
								  <tr>
                                    <td>Timing</td>
								  ...
								  <tr>
                                    <td>Detail About </td>
                                    <td><?php echo $row["description_detail"]; ?></td>
                                  </tr>
                                </tbody>
                              </table>
